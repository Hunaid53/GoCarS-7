...
public class CarControllers : MonoBehaviour
{
    ...
    public float aiAccerelateSpeed = 1f, aiTurnSpeed = .8f, aiReachPointRange = 5f, aiPointVarience = 3f, aiMaxTurn = 15f;
    ...
    void Update()
    {
        ...
        } else
        {
            ...
            {
                aiSpeedInput = Mathf.MoveTowards(aiSpeedInput, 1f, aiAccerelateSpeed);
            } else
            {
                aiSpeedInput = Mathf.MoveTowards(aiSpeedInput, aiTurnSpeed, aiAccerelateSpeed);
            }
    ...
    {
        targetPoint += new Vector3(Random.Range(-aiPointVarience, aiPointVarience), 0f, Random.Range(-aiPointVarience, aiPointVarience));
    }
}
